...
test_out_filename = "./output/ijcai2019/PATH_TO_TEST_MODEL/output_test.txt"
...
with open(test_out_filename, 'r') as f:
    ...
    # candidate size = 2, the result of Recall_2@1 may vary at different runs because the negative candidate is sampled randomly
